	...
	namespace fem  {
		namespace dof {
			...
			public:
				...
				// Node -> DOF indexing
				PDE_HOST PDE_DEVICE static Index getNodeDOF(const Index nodeId, const Index component, const Index dofsPerNode);
				PDE_HOST PDE_DEVICE static void getNodeDOFs(const Index nodeId, const Index dofsPerNode, Index* output);
				
				// Element -> DOF Indexing
				template<typename Element>
				PDE_HOST PDE_DEVICE static void getElementDOFs(const Index elemId, const Index dofsPerNode, Index* output);
