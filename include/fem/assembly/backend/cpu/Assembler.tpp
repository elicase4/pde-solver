...
requires std::same_as<Matrix, linalg::types::CSRMatrix<Real, linalg::types::backend::CPU>>
static Matrix Assembler::createMatrixSystem<Matrix>(const mesh::Mesh& mesh, const topology::TopologicalDOF& topoDOF){
...
requires std::same_as<Vector, linalg::types::Vector<Real, linalg::types::backend::CPU>>
static Vector Assembler::createOperatorSystem<Vector>(const mesh::Mesh& mesh, const topology::TopologicalDOF& topoDOF){
...
template<typename Vector>
requires std::same_as<Vector, linalg::types::Vector<Real, linalg::types::backend::CPU>>
static Vector Assembler::createRHSVector<Vector>(const mesh::Mesh& mesh, const topology::TopologicalDOF& topoDOF){
...
requires std::same_as<Matrix, linalg::types::CSRMatrix<Real, linalg::types::backend::CPU>>
void Assembler<linalg::types::backend::Serial>::assembleMatrixSystem<Matrix, EvalElement, Form>(const mesh::Mesh& mesh, const topology::TopologicalDOF& topoDOF, const Real time, Matrix& K){
...
requires std::same_as<Vector, linalg::types::Vector<Real, linalg::types::backend::CPU>>
void Assembler::assembleOperatorSystem<Vector, EvalElement, Form>(const mesh::Mesh& mesh, const topology::TopologicalDOF& topoDOF, const Real time, Vector& O){

}

template<typename Vector, typename EvalElement, typename Form>
requires std::same_as<Vector, linalg::types::Vector<Real, linalg::types::backend::CPU>>
void Assembler::assembleRHSVector<Vector, EvalElement, Form>(const mesh::Mesh& mesh, const topology::TopologicalDOF& topoDOF, const Real time, Vector& F){
